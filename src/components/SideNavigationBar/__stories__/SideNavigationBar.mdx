...
import * as SideNavigationBarStories from "./SideNavigationBar.stories";
import Props from "./Props.md?raw";

<Meta of={SideNavigationBarStories} />
...
const ItemsSection = styled.div<{ stickToBottom?: boolean }>`
  ...
  border-top: ${({ stickToBottom }) =>
    stickToBottom ? `solid 1px ${theme.color.divider.primary}` : "inherit"};
...
<Canvas>
  <Story of={SideNavigationBarStories.Default} />
</Canvas>

## non-expandable

<Canvas>
  <Story of={SideNavigationBarStories.NonExpandable} />
</Canvas>

## multiple sections with stick to bottom

<Canvas>
  <Story of={SideNavigationBarStories.MultipleSectionsWithStickToBottom} />
</Canvas>

## scrollable

<Canvas>
  <Story of={SideNavigationBarStories.Scrollable} />
</Canvas>
