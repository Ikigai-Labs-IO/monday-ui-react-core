...
import { ComponentRules, createComponentTemplate } from "@ikigailabs/storybook-components";
...
Avatars appear in 3 types: Initials, Photo, and Avatar Group.

<Canvas>
  <Story of={AvatarStories.Types} />
</Canvas>

### Size

Avatars appear in 4 sizes: Small, Medium, Large, and Extra-large.
