...
import { Link } from "@ikigailabs/storybook-components";
...
### Sizes
Labels appear in 4 sizes: Tiny, Small, Medium, and Large.

<Canvas>
  <Story of={LabelStories.Sizes} />
</Canvas>

### Corners

<Canvas>
  <Story of={LabelStories.BorderRadius} />
</Canvas>
