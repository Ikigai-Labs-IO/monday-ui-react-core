import { ComponentRules, UsageGuidelines } from "@ikigailabs/storybook-components";
...
<ul>
  <li>There is no “X” / close icon.</li>
  <li>You can click outside a modal to dismiss it.</li>
</ul>

<Canvas>
  <Story of={ModalStories.SingleLock} />
</Canvas>
...
<ul>
  <li>There is no “X” / close icon.</li>
  <li>You can’t click outside a modal to dismiss it.</li>
  <li>You can close it by using buttons only.</li>
</ul>

<Canvas>
  <Story of={ModalStories.DoubleLock} />
</Canvas>
